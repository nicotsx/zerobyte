...
export const getUserSsoInvitationsQueryKey = (options?: Options<GetUserSsoInvitationsData>) => createQueryKey('getUserSsoInvitations', options);

/**
 * Get pending SSO invitations for the authenticated user
 */
export const getUserSsoInvitationsOptions = (options?: Options<GetUserSsoInvitationsData>) => queryOptions<GetUserSsoInvitationsResponse, DefaultError, GetUserSsoInvitationsResponse, ReturnType<typeof getUserSsoInvitationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getUserSsoInvitations({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getUserSsoInvitationsQueryKey(options)
});

/**
 * Start SSO verification for accepting an organization invitation
 */
export const startInvitationSsoVerificationMutation = (options?: Partial<Options<StartInvitationSsoVerificationData>>): UseMutationOptions<unknown, DefaultError, Options<StartInvitationSsoVerificationData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<StartInvitationSsoVerificationData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await startInvitationSsoVerification({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getSnapshotUsageQueryKey = (options: Options<GetSnapshotUsageData>) => createQueryKey('getSnapshotUsage', options);

/**
 * Directory sizes within a snapshot, largest first
 */
export const getSnapshotUsageOptions = (options: Options<GetSnapshotUsageData>) => queryOptions<GetSnapshotUsageResponse, DefaultError, GetSnapshotUsageResponse, ReturnType<typeof getSnapshotUsageQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getSnapshotUsage({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getSnapshotUsageQueryKey(options)
});
...
/**
 * Append exclusion patterns to a backup schedule
 */
export const addExcludePatternsMutation = (options?: Partial<Options<AddExcludePatternsData>>): UseMutationOptions<AddExcludePatternsResponse, DefaultError, Options<AddExcludePatternsData>> => {
    const mutationOptions: UseMutationOptions<AddExcludePatternsResponse, DefaultError, Options<AddExcludePatternsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await addExcludePatterns({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listTaskHistoryQueryKey = (options?: Options<ListTaskHistoryData>) => createQueryKey('listTaskHistory', options);
...
export const listTaskHistoryInfiniteQueryKey = (options?: Options<ListTaskHistoryData>): QueryKey<Options<ListTaskHistoryData>> => createQueryKey('listTaskHistory', options, true);
