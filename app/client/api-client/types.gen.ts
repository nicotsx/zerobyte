...
export type ListVolumesResponses = {
    ...
    200: Array<{
        ...
        sourceLocation: {
            ...
            relativePath: string;
            availability: 'available' | 'offline' | 'connecting' | 'degraded' | 'revoked' | 'missing-agent' | 'root-removed' | 'incompatible' | 'backup-disabled' | 'not-ready';
        };
    }>;
};
...
export type ListSourceMachinesData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/api/v1/volumes/source-machines';
};
...
export type ListSourceMachinesResponse = ListSourceMachinesResponses[keyof ListSourceMachinesResponses];
