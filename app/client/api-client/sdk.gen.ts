 ...
 */
export const getSnapshotUsage = <ThrowOnError extends boolean = false>(options: Options<GetSnapshotUsageData, ThrowOnError>): RequestResult<GetSnapshotUsageResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetSnapshotUsageResponses, unknown, ThrowOnError>({ url: '/api/v1/repositories/{shortId}/snapshots/{snapshotId}/usage', ...options });

/**
 * Largest files in a snapshot, plus a rollup by file extension
 */
 ...
 */
export const addExcludePatterns = <ThrowOnError extends boolean = false>(options: Options<AddExcludePatternsData, ThrowOnError>): RequestResult<AddExcludePatternsResponses, unknown, ThrowOnError> => (options.client ?? client).post<AddExcludePatternsResponses, unknown, ThrowOnError>({
 ...
 */
export const runBackupNow = <ThrowOnError extends boolean = false>(options: Options<RunBackupNowData, ThrowOnError>): RequestResult<RunBackupNowResponses, RunBackupNowErrors, ThrowOnError> => (options.client ?? client).post<RunBackupNowResponses, RunBackupNowErrors, ThrowOnError>({ url: '/api/v1/backups/{shortId}/run', ...options });

/**
 * Manually apply retention policy to clean up old snapshots
 */
export const runForget = <ThrowOnError extends boolean = false>(options: Options<RunForgetData, ThrowOnError>): RequestResult<RunForgetResponses, RunForgetErrors, ThrowOnError> => (options.client ?? client).post<RunForgetResponses, RunForgetErrors, ThrowOnError>({ url: '/api/v1/backups/{shortId}/forget', ...options });
 ...
 */
export const cancelTask = <ThrowOnError extends boolean = false>(options: Options<CancelTaskData, ThrowOnError>): RequestResult<CancelTaskResponses, CancelTaskErrors, ThrowOnError> => (options.client ?? client).post<CancelTaskResponses, CancelTaskErrors, ThrowOnError>({ url: '/api/v1/tasks/{taskId}/cancel', ...options });
