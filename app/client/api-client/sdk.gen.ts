...
/**
 * Start a background lookup of snapshots missing from a mirror repository
 */
export const startMirrorStatus = <ThrowOnError extends boolean = false>(options: Options<StartMirrorStatusData, ThrowOnError>): RequestResult<StartMirrorStatusResponses, unknown, ThrowOnError> => (options.client ?? client).post<StartMirrorStatusResponses, unknown, ThrowOnError>({ url: '/api/v1/backups/{shortId}/mirrors/{mirrorShortId}/status', ...options });
