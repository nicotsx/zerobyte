...
test("labels equal and growing byte totals as processed and discovered data", () => {
	...
	expect(screen.getByText((_, element) => element?.textContent === "1 MiB discovered so far")).toBeTruthy();
	...
	expect(screen.getByText((_, element) => element?.textContent === "2 MiB discovered so far")).toBeTruthy();
});
